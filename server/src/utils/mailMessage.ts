const mailTemplate = (
  ...
  body {font-family: 'Chivo', sans-serif;}
    ...
    <![endif]-->
      ...
      <tbody>
        <tr>
          <td style="padding:18px 40px 0px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: inherit"><span style="color: #00634a; font-size: 24px">We received a request to log you into our website</span></div><div></div></div></td>
        </tr>
      </tbody>
      ...
      <tbody>
        <tr>
          <td style="padding:18px 40px 10px 0px; line-height:18px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: inherit"><span style="color: #00634a"><strong>enter the below code to continue</strong></span></div><div></div></div></td>
        </tr>
      </tbody>
    </table><table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="624a1be8-4d21-4faf-87db-30f2e5e2a80d" data-mc-module-version="2019-10-22">
      <tbody>
        <tr>
          <td style="padding:18px 0px 18px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: inherit"><span style="font-size: 36px"><strong>${code}</strong></span></div><div></div></div></td>
        </tr>
      </tbody>
  ...
  <div style="font-family: inherit; text-align: inherit"><span style="color: #00634a">Call Us at +33 80345690</span></div>
  <div style="font-family: inherit; text-align: inherit"><span style="color: #00634a">or Email at security-suppprt@sandown.com</span></div><div></div></div></td>
        </tr>
      </tbody>
...
const mailMessage = (code: string, to: string) => ({
  to,
  from: "sreeg459@gmail.com", // Use the email address or domain you verified above
  subject: "WIII login request",
